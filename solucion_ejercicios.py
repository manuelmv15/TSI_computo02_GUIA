...
def ejercicio_1():
    print("DEBUG: Entrando a ejericicio_1")
...
if __name__ == "__main__":
    ejercicio_1()
    input("\nPresiona Enter para continuar al Ejercicio 2")
    ejercicio_2()
    input("\nPresiona Enter para continuar al Ejercicio 3")
    ejercicio_3()
    input("\nPresiona Enter para continuar al Ejercicio 4")
    ejercicio_4()
    input("\nPresiona Enter para continuar al Ejercicio 5")
    ejercicio_5()
    input("\nPresiona Enter para continuar al Ejercicio 6")
    ejercicio_6()
    input("\nPresiona Enter para continuar al Ejercicio 7")
    ejercicio_7()
    input("\nPresiona Enter para continuar al Ejercicio 8")
    ejercicio_8()
    input("\nPresiona Enter para continuar al Ejercicio 9")
    ejercicio_9()
    input("\nPresiona Enter para continuar al Ejercicio 10")
    ejercicio_10()
    input("\nPresiona Enter para continuar al Ejercicio 11")
    ejercicio_11()
    input("\nPresiona Enter para continuar al Ejercicio 12")
    ejercicio_12()
    input("\nPresiona Enter para continuar al Ejercicio 13")
    ejercicio_13()
    input("\nPresiona Enter para continuar al Ejercicio 14")
    ejercicio_14()
    input("\nPresiona Enter para continuar al Ejercicio 15")
    ejercicio_15()
    input("\nPresiona Enter para continuar al Ejercicio 16")
    ejercicio_16()
    input("\nPresiona Enter para continuar al Ejercicio 17")
    ejercicio_17()
    input("\nPresiona Enter para continuar al Ejercicio 18")
    ejercicio_18()
    input("\nPresiona Enter para continuar al Ejercicio 19")
    ejercicio_19()
    input("\nPresiona Enter para continuar al Ejercicio 20")
    ejercicio_20()
